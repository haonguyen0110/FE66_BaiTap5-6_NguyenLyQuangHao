    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Fetures</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Pricing</a>
                </li>
                <li *ngIf="isLogin" class="nav-item">
                    <a class="nav-link" href="#"><b>Hello {{userName}}</b></a>
                </li>
                <li *ngIf="isLogin" class="nav-item">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                       <p>Password</p>
                       <input type="password" class="form-control" [(ngModel)]="userLogin.pass">
                   </div>
                    </div>
...
export class BaiTapLoginComponent implements OnInit {
    ...
    login = () => {
        if (this.userLogin.username === 'cybersoft' && this.userLogin.pass === 'cybersoft') {
